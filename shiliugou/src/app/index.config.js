(function() {
    ...
    /** @ngInject */
    function config($logProvider, $mdThemingProvider, $provide, $mdDateLocaleProvider) {
        ...
        $mdDateLocaleProvider.days = ['星期日', '星期六', '星期五', '星期四', '星期三', '星期二', '星期一'];
        $mdDateLocaleProvider.shortDays = ['日', '六', '五', '四', '三', '二', '一'];
